...
public class Serv_Jugador{
    ...
    public void read() {
        DAO_Jugador consulta = new DAO_Jugador();
        List<Jugador> listaJ = new ArrayList<>();
        List<DTO_Jugador> jugadoresDTO = new ArrayList<>();

        jugadoresDTO = consulta.hacerSelect("SELECT * from Jugador");
        listaJ = convertirJugadoresDTOaJugadores(jugadoresDTO);
        printJugadores(listaJ);
    }

    public void insert(DTO_Jugador obj) {
        DAO_Jugador consulta = new DAO_Jugador();
     ...
     * @return
     */
    private static List<Jugador> convertirJugadoresDTOaJugadores(List<DTO_Jugador> listaDTO){
        List<Jugador> listaJ = new ArrayList<>();
